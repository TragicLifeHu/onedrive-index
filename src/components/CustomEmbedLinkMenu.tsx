    ...
    <>
      ...
      <div className="group relative mb-2 max-h-24 overflow-y-scroll rounded border border-gray-400/20 bg-gray-50 p-2.5 font-mono break-all dark:bg-gray-800">
        ...
        <button
          ...
          className="dark:bg-gray-800 absolute top-[0.2rem] right-[0.2rem] w-8 rounded border border-gray-400/40 bg-gray-100 py-1.5 opacity-0 transition-all duration-100 group-hover:opacity-100 hover:bg-gray-200 dark:hover:bg-gray-700"
        >
